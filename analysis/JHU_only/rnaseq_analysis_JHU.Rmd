...
knitr::opts_chunk$set(echo = TRUE, tidy.opts=list(width.cutoff=50), tidy=TRUE, fig.width=12, fig.height=8,fig.path = "/Users/xdoan/Shell/R/MPNSTAnalysis/analysis/JHU_only/figs/", dev=c('png', 'pdf'))
...
write.csv(res_df, file = "JHU_only/data/pNF_v_MPNST_geneList.csv", row.names = TRUE)
```
...
write.csv(ego,file="JHU_only/data/pNFvMPNST_GO_overRep.csv", row.names = FALSE)
```
...
```
```{r}
write.csv(kk,file="JHU_only/data/pNFvMPNST_KEGG.csv", row.names = FALSE)
